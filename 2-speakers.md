...
{% include figure.html img="takayuki-kanda.jpeg" alt="Takayuki Kanda" width="50%" %}
...
{% include figure.html img="james-kennedy.jpg" alt="James Kennedy" width="50%" %}
...
{% include figure.html img="haewon-park.jpg" alt="Hae Won Park" width="50%" %}
...
{% include figure.html img="oggi-rudovic.jpg" alt="Ognjen Rudovic" width="50%" %}
